        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group basic">
                    <div class="input-wrapper">
                        <label class="label" for="name">Nama</label>
                        <input type="text" class="form-control" value="{{auth()->user()->nama}}" name="nama" id="nama" placeholder="Nama">
                    </div>
                </div>
                ...
                <div class="form-group basic">
                    <div class="input-wrapper">
                        <label class="label" for="name">Tanggal Lahir</label>
                        <input type="date" class="form-control" value="" name="tanggal_lahir" id="tanggal_lahir" placeholder="Tanggal Lahir">
                    </div>
                </div>
                <div class="form-group basic">
                    <div class="input-wrapper">
                        <label class="label" for="name">Alamat</label>
                        <textarea type="text" class="form-control" value="" name="alamat"  placeholder="Alamat"></textarea>
                    </div>
                </div>
            ...
            <div class="form-group basic">
                ...
                <div class="form-group basic">
                    <div class="input-wrapper">
                        <label class="label" for="name">No Telepon</label>
                        <input type="number" class="form-control" value="" name="no_telp" placeholder="No Telepon">
                    </div>
                </div>
                ...
                <div class="form-group basic">
                    <div class="input-wrapper">
                        <label class="label" for="name">Berat Badan</label>
                        <input type="number" class="form-control" value="" name="berat_badan"  placeholder="Berat Bada">
                    </div>
                </div>
                ...
                <div class="form-group basic">
                    <div class="input-wrapper">
                        <label class="label" for="name">Tinggi Badan</label>
                        <input type="number" class="form-control" value="" name="tinggi_badan" iplaceholder="Tinggi Badanr">
                    </div>
                </div>
            </div>
        </div>
